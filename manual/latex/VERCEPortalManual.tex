...
\sphinxstylestrong{Figure 8.3:} Creating the zip files needed to upload a new model to
...
\sphinxstylestrong{Figure 8.4:} The parameter form for inputting a new mesh and model
into the VERCE platform.

\sphinxstylestrong{8.4 Submitting a new earthquake catalogue}

If you wish to submit your own earthquake catalogue, you can do this on
the ‘\sphinxstyleemphasis{File’} tab of the ‘Earthquakes’ page shown in figure 8.5. The
...
\sphinxstylestrong{Figure 8.5:} The input form for bespoke user input earthquake
catalogues.
...
\sphinxstylestrong{Figure 8.6:} The input form for new seismic station networks.

\sphinxincludegraphics{{image74}.png}

\sphinxstylestrong{Figure 8.7:} The input format for stations and networks to be added
...
\sphinxstylestrong{Figure A1.7:} Parameter form for ‘Group 5 \textendash{} Seismograms’.
...
\sphinxstylestrong{Figure A1.8:} Parameter form for ‘Group 6 \textendash{} Sources’.
...
\sphinxstylestrong{Figure A1.9:} Parameter form for ‘Group 7 \textendash{} Visualisation’.
...
\sphinxstylestrong{Figure A1.10:} Parameter form for ‘Group 8 \textendash{} Adjoint Kernel
Options’.
...
\begin{center}\sphinxstylestrong{Figure A1.11:} Parameter form for ‘Group 9 \textendash{} Advanced’.
\end{center}
...
\sphinxstylestrong{Figure A2.1:} The ObsPy logo
...
\sphinxstylestrong{Figure A2.2:} Z-component data plotted using ObsPy. Image
re-produced from
...
\sphinxstylestrong{Figure A3.1:} The Dispel4Py logo.
...
\sphinxstylestrong{Figure A3.2:} An example of a workflow to perform a cross
