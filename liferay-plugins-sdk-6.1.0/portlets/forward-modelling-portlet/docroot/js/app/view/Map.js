...
Ext.define('CF.view.Map', {
    ...
    initComponent: function() {
            ...
            new OpenLayers.Control.SelectFeature([stationLayer, eventLayer], {
                ...
                onSelect: function(feature) {
                    if (feature.data.network != null && feature.data.station != null) {
                        ...
                        Ext.getCmp('stationSelColumn').setText(selectedStations + 1 + "/" + Ext.data.StoreManager.lookup('stationStore').data.length);
                        ...
                        Ext.getCmp('eventSelColumn').setText(selectedEvents + 1 + "/" + Ext.data.StoreManager.lookup('eventStore').data.length);
                    }
                },
                onUnselect: function(feature) {
                    if (feature.data.network != null && feature.data.station != null) {
                        ...
                        Ext.getCmp('stationSelColumn').setText(selectedStations <= 0 ? 0 : selectedStations - 1 + "/" + Ext.data.StoreManager.lookup('stationStore').data.length);
                    } else if (feature.data.eventId != null) {
                        var eventGrid = controller.getEventGrid();
                        var idx = eventGrid.store.findExact('eventId', feature.data.eventId);
                        ...
                        Ext.getCmp('eventSelColumn').setText(selectedEvents <= 0 ? 0 : selectedEvents - 1 + "/" + Ext.data.StoreManager.lookup('eventStore').data.length);
                    }
                },
            }),
        ]);
        ...
        items.push({
            ...
            text: 'Layers info',
            menuAlign: 'tr-br',
            menu: Ext.create('layersMenu', {}),
            arrowHandler: function() {
                this.menu = Ext.create('layersMenu', {});
            }
        });
