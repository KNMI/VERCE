						           			...
						           			buttons: [ {
 										           ...
 										           var form = this.up('form').getForm();
  													          if (form.isValid()) {
   													              artifactStore.setProxy({
									 						           type : 'ajax',
  							      									   url: '/j2ep-1.0/prov/entities/content?'+form.getValues(true),
...
function renderStream(value, p, record) {
        return Ext.String.format(
            ...
            '<strong>Stream Data ID: <a href="javascript:newGraph(\'/j2ep-1.0/prov/trace/{0}?level='+level+'\')">{0} </a></strong> <br/> <br/>'+
