...
var node = graph.addNode(data["streams"][0]["id"],{label:data["_id"].substring(0,5),'color':colour.orange, 'shape':'dot', 'radius':19,'alpha':1 })
...
var params = graph.addNode(data["streams"][0]["id"]+"params",{label:JSON.stringify(data["parameters"])})
graph.addEdge(params.name,data["streams"][0]["id"],{label:"wasGeneratedBy"})
...
sys.parameters({stiffness:100, gravity:true, dt:0.015})
