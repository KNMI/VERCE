  ...
  Ext.define('CF.controller.Map', {
      ...
      getStations: function(elem, purl, formatType) {
          ...
          this.getStore('stationStore').bind(stationLayer);
      ...
      getEvents: function(elem, purl) {
          ...
          this.getStore('eventStore').bind(eventLayer);
      ...
      showEventInfo: function(evtfeature) {
          ...
          grid.getView().focusRow(this.getStore('eventStore').getByFeature(evisfeature));
      ...
      showStationInfo: function(stfeature) {
          ...
          grid.getView().focusRow(this.getStore('stationStore').getByFeature(svisfeature));
