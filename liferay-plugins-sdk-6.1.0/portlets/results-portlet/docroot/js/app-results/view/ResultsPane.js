...
Ext.define('RS.view.provenanceGraphsViewer', {
  ...
  items: [{
    ...
    xtype: 'panel',
    html: '<strong>Double Click on the Target Dots to expand. Right Click to see the content</strong>'+
          '<div class="my-legend">'+
		  '<div class="legend-title"></div>'+
		  '<div class="legend-scale">'+
          '<ul class="legend-labels">'+
    	  '<li><span style="background:'+colour.darkblue+'"></span>stream</li>'+
    	  '<li><span style="background:'+colour.red+'"></span>expanded</li>'+
     	  '<li><span style="background:'+colour.lightgrey+'"></span>state</li>'+
   		  '<li><span style="background:'+colour.lightblue+'"></span>no-stream</li>'+
   		  '</ul></div></div>'+
