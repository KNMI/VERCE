...
Ext.define('RS.view.metaCombo', {
  ...
  colspan: 4,
  multiSelect:true,
  store: Ext.create('RS.store.SeismoMeta'),
  queryMode: 'local',
...
var workflowgrid=Ext.create('RS.view.WorkflowSelection')
...
var workflowValuesRangeSearch = Ext.create('RS.view.WorkflowValuesRangeSearch')
var workflowOpenByRunID = Ext.create('RS.view.WorkflowOpenByRunID')
