...
class kmlGenerator_INGV(SeismoPreprocessingActivity):
    ...
    def compute(self):
        ...
        self.addOutput(head+"/../OUTPUT_FILES/"+self.runId+".kmz",location="file://"+socket.gethostname()+head+"/../OUTPUT_FILES/"+self.runId+".kmz",format="application/vnd.google-earth.kmz")
              
            
        return "true"

if __name__ == "__main__":
    proc=kmlGenerator_INGV("kmlGenerator_INGV Script")
    proc.process();