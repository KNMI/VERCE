...
python -m dispel4py.new.processor multi test.misfit_preprocessing.create_misfit_prep -n 22 -f test/misfit_preprocessing/misfit_input.jsn
#python -m dispel4py.new.processor simple test.misfit_preprocessing.create_misfit_prep  -f test/misfit_preprocessing/misfit_input.jsn
