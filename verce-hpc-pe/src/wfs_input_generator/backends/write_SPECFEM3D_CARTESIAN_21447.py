...
DEFAULT_CONFIGURATION = {
    ...
    "PML_WIDTH_MIN":(10000.0,float,"C-PML thickness min"),
    "PML_WIDTH_MAX":(25000.0,float,"C-PML thickness max"),
...
def write(config, events, stations):
    ...
    par_file_template = (
        ...
        "ABSORB_INSTEAD_OF_FREE_SURFACE  = {ABSORB_INSTEAD_OF_FREE_SURFACE}\n"
        "\n"
        "# C-PML absorbing boundary conditions for a regional simulation\n"
        ...
        "PML_WIDTH_MIN                   = {PML_WIDTH_MIN}\n"
        "PML_WIDTH_MAX                   = {PML_WIDTH_MAX}\n"
        "\n"
    ...
    CMT_SOLUTION_template = (
        "PDE {time_year:04d} {time_month:02d} {time_day:02d} {time_hh:02d} {time_mm:02d} "
