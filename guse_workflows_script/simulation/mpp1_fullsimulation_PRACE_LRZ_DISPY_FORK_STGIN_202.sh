...
#cd bin/
python $RUN_PATH/verce-hpc-pe/src/bulk_run_specfem_movie.py $RUN_PATH/jsonout_inputgen $RUN_PATH/jsonout_decompose $RUN_PATH/solverconf poe $COUNTER 
...
poe python -m dispel4py.new.processor -t mpi  test.hpc.forwardsim.postproc_graph
