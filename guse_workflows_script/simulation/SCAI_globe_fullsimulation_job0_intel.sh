...
module load tools/python/2.7.9 intel/studio/2015.1.133 tools/ffmpeg libs/blas/openblas/0.2.19-gcc-5.4.0-sandy
...
python $RUN_PATH/verce-hpc-pe/src/run_specfemGlobe_compile.py $RUN_PATH/jsonout_inputgen $INPUTS/Par_file $INPUTS/CMTSOLUTION $INPUTS/STATIONS Intel
...
python $RUN_PATH/verce-hpc-pe/src/bulk_run_specfemGlobe_movie.py $RUN_PATH/jsonout_inputgen $RUN_PATH/jsonout_mesher $RUN_PATH/solverconf mpiexec.hydra $COUNTER "$MYMPIEXEC_CMD_PAR_MOV"  
