...
module load python/2.7.6 globus
...
echo globus-url-copy -cd -r -v -c -fast -cc 4 -stall-timeout 30 $i gsiftp://dir-irods.epcc.ed.ac.uk/~/verce/$i
globus-url-copy -cd -r -v -c -fast -cc 4 -stall-timeout 30 $i gsiftp://dir-irods.epcc.ed.ac.uk/~/verce/$i
done
